...
namespace WEXO_Test_Sorting_Blacklist.DB
{
    /**
    ...
    public class BlackListDB
    {
        ...
        public BlackListDB()
        {
            _connectionString = "Server=hildur.ucn.dk;Database=DMA-CSD-S232_10503092;User Id=DMA-CSD-S232_10503092;Password=Password1!;TrustServerCertificate=True";
        }
         ...
         */
        public List<testmac> GetBlacklistedMACs()
        {
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                conn.Open();
                string query = "SELECT MAC FROM dbo.Blacklist";
                return conn.Query<testmac>(query).ToList();
            }
        }
         ...
         */
        public List<testdesc> GetBlackListedDescriptions()
        {
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                conn.Open();
                string query = "Select deviceDescription FROM dbo.BlacklistDescription";
                var result = conn.Query<testdesc>(query).ToList();
         ...
         */
        public void CreateDescription(ActualDescription obj)
        {
